...
func init() {
	...
	url := flag.String("u", "ws://127.0.0.1:8555", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "小wv", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:      append([]string{*adana}, "小wv"),
